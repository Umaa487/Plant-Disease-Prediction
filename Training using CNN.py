...
training_set = train_datagen.flow_from_directory('/content/drive/MyDrive/Train',# relative path from working directoy
                                                 target_size = (128, 128),
                                                 batch_size = 6, class_mode = 'categorical')
valid_set = test_datagen.flow_from_directory('/content/drive/MyDrive/Valditation', # relative path from working directoy
                                             target_size = (128, 128),
